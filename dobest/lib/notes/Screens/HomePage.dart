            ...
            BlocBuilder<GeneralBloc, GeneralState>(
              builder: (context, state) => SliverAppBar(
                ...
                leading: IconButton(
                  splashRadius: 20,
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => MyAppTasks()));
                  },
                  icon: Icon(Icons.fact_check_outlined, color: Colors.black, size: 32,),
                ),
                actions: [
                  BlocBuilder<NotesBloc, NotesState>(
                    builder: (context, state) => IconButton(
                      ...
                      icon: Icon( state.isList ? Icons.view_agenda_outlined : Icons.grid_view_rounded, size: 30, color: Colors.black),
                    ),
                  )
                ],
              ),
