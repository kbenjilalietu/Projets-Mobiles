    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: const TextFrave(text: 'Add Note', fontWeight: FontWeight.w500, fontSize: 24, isTitle: true),
        ),
        centerTitle: true,
        leading: InkWell(
          ...
          child: Center(
            child: Padding(
              ...
              child: const TextFrave(text: ' Cancel', fontSize: 17, color: Colors.blueGrey,),
            )
          )
        ),
        actions: [
          InkWell(
            ...
            child: Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(top: 35, bottom: 20),
                child: const TextFrave(text: 'Save', fontSize: 18, color: Color(0xff0C6CF2)),
              )
            ),
          )
        ],
